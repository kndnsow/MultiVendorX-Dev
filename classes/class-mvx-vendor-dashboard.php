                ...
                foreach ($customer_orders as $commission_id => $customer_order) {
                    ...
                    if (sizeof($vendor_items) > 0) {
                        ...
                        $order_datas[$index] = apply_filters('mvx_vendor_order_generate_csv', array(
                            ...
                            'tax' => get_mvx_order_commission_data($commission_id, '_tax', true),
                            'shipping' => get_mvx_order_commission_data($commission_id, '_shipping', true),
                            'commission_share' => get_mvx_order_commission_data($commission_id, '_commission_amount', true),
